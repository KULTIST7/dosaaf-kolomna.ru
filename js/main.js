$(document).ready(() => {
	$('.faq .faq__item .faq__item__answer').slideUp(0);
...
/******/ (() => {
    ...
    support
      ...
      `;
		...
		const types_categories_slider_sliderEl = document.querySelector(".types__categories__slider");
		if (types_categories_slider_sliderEl) {
			let types = ["M", "A1", "A", "B", "C", "D", "BE", "CE", "DE", "САМОХОДНЫЕ ТС"];
			let typesCategoriesSlider = new core(types_categories_slider_sliderEl, {
				slidesPerView: 1,
				speed: 600,
				effect: "fade",
				fadeEffect: {
		...
		var contacts_map = __webpack_require__(622);
